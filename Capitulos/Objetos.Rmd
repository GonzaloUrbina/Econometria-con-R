...
# Renombrar los niveles del factor. Se debe hacer en orden por lo que se desaconseja hacer por separado. En la sección de Gestión de Datos veremos como manipular factores más a fondo.
